                    ...
                    <?php for($i=0; $i<=10; $i++) {?>
                        <tr>
                            ...
                            <td> <div class="progress">
                                <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" role="progressbar" style="width: <?php echo $numerorand ?>%;" aria-valuenow="<?php echo $numerorand ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $numerorand ?>%</div>
                            </div></td>
                        <?php }?>
                        </tr>
                    </tbody>
